      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Our complete package designed for exceptional innovators seeking recognition
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Perfect for initial review</p>
              </div>
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Basic Feedback Report</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-blue-500 relative">
              ...
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Priority</h3>
                <div className="text-4xl font-bold text-gray-900 mb-2">$250</div>
                <p className="text-gray-600">Expedited review process</p>
              </div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>5 Expert Reviewers</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Expedited Timeline (1 week)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>1 Mentor Session</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Priority Grant Consideration</span>
                </li>
              </ul>
              <button
                onClick={onShowAuth}
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Complete support package</p>
              </div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>7+ Expert Reviewers</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Priority Review (3-5 days)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>3 Mentor Sessions</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Pitch Day Access</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
              ...
              <button
                onClick={onShowAuth}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all font-medium"
              >
                Go Premium
              </button>
            </div>
